      ...
      <div className="px-5">
        <Card>
          {list.length === 0 ? (
            ...
            return <TxRow key={t.id} cat={c} desc={t.description || c.label} amount={parseFloat(t.amount) || 0} date={fmtDay(t.date)} sub={c.label} sign="+" onPress={() => setDetail(t)} last={i === list.length - 1} />;
          })}
        </Card>
      </div>
