        ...
        <div className="min-h-screen bg-slate-950 text-slate-50 font-sans selection:bg-blue-500/30">
            ...
            <nav className="fixed w-full z-50 bg-slate-950/80 backdrop-blur-md border-b border-white/10">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <img src={logo} alt="Mêntor Logo" className="w-10 h-auto" />
                        <span className="font-black text-2xl tracking-tighter text-white">Mêntor</span>
                    </div>
                    <button
                        onClick={onLogin}
            ...
            <footer className="py-12 border-t border-slate-900 bg-slate-950">
                <div className="max-w-7xl mx-auto px-6 text-center text-slate-500">
                    <p className="mb-4">&copy; {new Date().getFullYear()} Mêntor. Todos os direitos reservados.</p>
