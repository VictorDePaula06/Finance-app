            ...
            <div key={expense.id} className={`p-5 rounded-2xl group relative transition-all hover:shadow-xl hover:-translate-y-1 ${
              ...
              <div className="mt-4">
                  {!isPaidThisMonth ? (
                      ...
                      <div className="w-full py-2.5 rounded-lg font-bold text-xs uppercase tracking-wider bg-emerald-500/10 text-emerald-500 flex items-center justify-center gap-2">
