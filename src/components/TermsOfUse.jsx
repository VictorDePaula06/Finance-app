            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-12 leading-relaxed">
                    <section>
                        ...
                        <p>
                            Ao acessar e utilizar o **Mêntor**, você concorda em cumprir e estar vinculado a estes Termos de Uso. Este aplicativo é uma ferramenta de auxílio à gestão financeira pessoal e não substitui o aconselhamento de profissionais certificados.
                        </p>
                    </section>
                    ...
                    <section>
                        ...
                        <p className="mb-4">
                            O Mêntor utiliza Inteligência Artificial (Gemini) para fornecer sugestões e análises. **Você reconhece que:**
                        </p>
